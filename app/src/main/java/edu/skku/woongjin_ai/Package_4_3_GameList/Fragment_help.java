...
public class Fragment_help extends Fragment {
    ...
    private Fragment_help.OnFragmentInteractionListener mListener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState){
        ...
        type = getArguments().getString("gamelist");
    ...
    public void onAttach(Context context) {
        ...
        if (context instanceof Fragment_help.OnFragmentInteractionListener) {
            mListener = (Fragment_help.OnFragmentInteractionListener) context;
        } else {
